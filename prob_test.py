...
x = prob_a_or_b(evens, odds, all_possible_rolls)
print(x)
...
y = prob_a_or_b(odds, greater_than_two, all_possible_rolls)
print(y)
...
z = prob_a_or_b(diamond_cards, face_cards, all_possible_cards)
print(z)